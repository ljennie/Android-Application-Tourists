...
public class EventAdapter extends BaseAdapter {//EventAdapter:把数据和view load中间的class
    Context context;
    ...
    @Override
    public int getCount() {//有多少行
        return eventData.size();
    }

    @Override
    public Event getItem(int position) {// 每行对应的item是什么
